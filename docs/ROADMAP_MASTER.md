...
| **AOP-STREAMING** | Reactive Operational Streaming (SSE) | Observability | Streaming reactivo de eventos operacionales vía Server-Sent Events, replay desde Last-Event-ID, heartbeat y fallback a polling. | `DONE` | HIGH | v1.3 | `src/application/observability/event-stream-adapter.ts`, `src/platform/api/http-router.ts` | 8 tests | `docs/decisions/0029-reactive-operational-streaming-sse.md` | AOP-PROD-001 | Prompt 108 |
| **AOP-V1-EXIT** | Certificación Final de Criterios de Producción | Governance | Auditoría y certificación integral de criterios de release formal para v1.0/v1.1/v1.2/v1.3 (`CERTIFIED WITH OPEN GAPS`). | `VALIDATION` | CRITICAL | v1.3 | `docs/RELEASE_CERTIFICATION_V1.md` | 1399 tests | `docs/V1_EXIT_CRITERIA.md` | Todos los anteriores | Prompt 106 |
