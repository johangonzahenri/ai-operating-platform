...
export interface ToolDefinition { readonly id: string; readonly name: string; readonly description: string; readonly version?: string | undefined; readonly inputSchema: ToolInputSchema; readonly metadata?: Readonly<Record<string, unknown>> | undefined; }
export interface ToolRequest { readonly toolId: string; readonly input: Readonly<Record<string, unknown>>; }
export interface ToolResult { readonly output: Readonly<Record<string, unknown>>; readonly metadata?: Readonly<Record<string, unknown>> | undefined; }
