/**
 * AR Asset Governance & Virtual Fitting Room Domain
 * AI Operating Platform - AR Experience System
 */
...
const URN_REGEX = /^urn:[a-z0-9-]+:ar:(footwear|apparel|outerwear|accessories):([a-z0-9-]+)$/;
