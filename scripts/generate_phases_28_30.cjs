...
// 1. src/infrastructure/model/real-providers.ts
...
// 2. src/application/model/governed-model-router.ts
...
// 3. src/application/platform/ar-asset-registry.ts
...
// 4. src/infrastructure/media/virtual-tryon-provider.ts
const virtualTryonProviderCode = `import { ArAssetDefinition } from "../../application/platform/ar-asset-registry.js";
...
// 5. src/application/automation/webhook-dispatcher.ts
...
// 6. src/application/automation/scheduler-service.ts
...
// 7. src/application/automation/n8n-adapter.ts
...
// 8. src/application/automation/reporting-service.ts
...
console.log('Phases 28-30 core TypeScript modules generated.');
